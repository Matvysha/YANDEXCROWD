...
function createSlideShow(gridStepsSelector) {
  ...
  const prevButton = document.querySelector('.slider-controls__btn_type_prev');
  const nextButton = document.querySelector('.slider-controls__btn_type_next');
  const indicatorsContainer = document.querySelector('.slider-controls__btn-container');
